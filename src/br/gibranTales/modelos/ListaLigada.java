...
public class ListaLigada {
	...
	public void adicionarNoComeco(Aviao novoElemento) {
	...
	public void adicionarNoFinal(Aviao novoElemento) {
	...
	public void adicinarNaPosicao(Aviao novoElemento, int posicao) {
	...
	public Aviao pegar(int posicao) {

		return pegarCelula(posicao).getElemento();

	}

	public boolean contem(Aviao elementoBuscado) {
